...
export function renderDynamicGrid({ display, split, gf, zoomLevel }, onZoomChange) {
  ...
  const col = (title, list) => {
    ...
    return `<div class="bracket-column">
      <div class="bracket-round">
        <div class="bracket-header-title"><strong>${title}</strong></div>
        ${items}
      </div>
    </div>`;
  };
  ...
  grid.innerHTML = `
    ...
    ${col('Quarter-Finals', split.qf.left)}
    ${col('Semi-Finals', split.sf.left)}
    <div class="bracket-column">
      <div class="bracket-round">
        <div class="bracket-header-title"><strong>Grand Final</strong></div>
        ${gfBox}
      </div>
    </div>
    ${col('Semi-Finals', split.sf.right)}
    ${col('Quarter-Finals', split.qf.right)}
